        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div
                ...
                className="bg-gray-800/40 backdrop-blur-md rounded-3xl p-8 md:p-10 border border-gray-700/50 shadow-2xl"
            >
          ...
          <div className="bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-md rounded-3xl border border-gray-700/50 p-10 text-center shadow-xl">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Слідкуйте за нами</h2>
            ...
            <div className="flex justify-center space-x-6">
              {[
                { icon: "📸", label: "Instagram", href: "https://www.instagram.com/perm.fush/" },
