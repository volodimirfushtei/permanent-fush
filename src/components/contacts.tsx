...
export default function Contacts({ children }: ContactsProps) {
  ...
  return (
    <div
      ref={pageRef}
      className="min-h-screen bg-gradient-to-b from-gray-950 to-black pt-20 pb-16 relative"
    >
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-8 ">
            ...
            <div
              ref={mapRef}
              className="bg-black/10 border-2 border-gray-600 rounded-3xl p-6 shadow-xl"
            >
              <h2 className="text-2xl font-bold text-left text-gray-400 mb-1">
                Адреса
              </h2>
            ...
            <div
              ref={infoRef}
              className="bg-black/90 border-2 border-gray-600 rounded-3xl p-6 shadow-xl"
            >
              <h2 className="text-2xl font-bold text-gray-400 mb-6">
                Контактна інформація
              </h2>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-lg font-semibold text-gray-400 hover:text-amber-600 transition-colors"
                    >
                      +38 (099) 123-45-67
                    </a>
                  </div>
