...
export default function BrowsCoursePage() {
  ...
  const benefits = [
    {
      icon: "🎓",
      title: "Сертифікат",
      description: "Офіційний сертифікат про завершення курсу",
    },
    {
      icon: "📚",
      title: "Навчальні матеріали",
      description: "Доступ до всіх навчальних матеріалів назавжди",
    },
    {
      icon: "👩‍🏫",
      title: "Наставництво",
      description: "Персональний куратор протягом всього навчання",
    },
    {
      icon: "💼",
      title: "Бізнес-підтримка",
      description: "Допомога у запуску власної справи",
    },
    {
      icon: "📱",
      title: "Онлайн-спільнота",
      description: "Доступ до закритої спільноти випускників",
    },
    {
      icon: "🔄",
      title: "Доступ назавжди",
      description: "Можливість перегляду уроків у будь-який час",
    },
  ];
  ...
  const reviews = [
    {
      name: "Анна",
      text: "Пройшла курс місяць тому, вже маю стабільних клієнтів. Якісні матеріали та підтримка куратора!",
    },
    {
      name: "Ірина",
      text: "Навчалась у інших, але тут найкращий підхід. Все зрозуміло та доступно, навіть для новачків.",
    },
    {
      name: "Оксана",
      text: "Після курсу відкрила свій кабінет. Дякую за бізнес-консультації та підтримку!",
    },
  ];
  ...
  return (
    <div
      ref={pageRef}
      className="min-h-screen bg-black/90 from-amber-50 to-white"
    >
      {/* Hero Section */}
      <section
        style={{
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Онлайн-курс{" "}
              <span className="text-amber-200">Перманентний макіяж брів</span>
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Комплексна програма, яка поєднує теоретичні знання з практичними
              навичками
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="course-card bg-white p-6 rounded-2xl shadow-lg border border-amber-100"
              >
      ...
      <section className="py-20 course-section">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Оберіть оптимальний пакет навчання
            </p>
          </div>
