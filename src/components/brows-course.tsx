        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Комплексний підхід, який гарантує ваш успіх у сфері перманентного
              макіяжу
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="animate-card bg-white/80 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100"
              >
            ...
            {activeTab === "program" && (
              <div className="space-y-6">
                {courseModules.map((module, index) => (
                  <div
                    key={index}
                    className="animate-card bg-gradient-to-r from-amber-50 to-rose-50 p-8 rounded-2xl shadow-lg border border-amber-100"
                  >
